...
#ifndef WHEELIEBOT_PATH_PLANNER__A_STAR_PATH_PLANNER_COMPONENT_HPP_
#define WHEELIEBOT_PATH_PLANNER__A_STAR_PATH_PLANNER_COMPONENT_HPP_
...
{
class AStarPathPlannerComponent : public rclcpp::Node
{
public:
  AStarPathPlannerComponent();
  explicit AStarPathPlannerComponent(rclcpp::NodeOptions const & options);
...
#endif  // WHEELIEBOT_PATH_PLANNER__A_STAR_PATH_PLANNER_COMPONENT_HPP_
