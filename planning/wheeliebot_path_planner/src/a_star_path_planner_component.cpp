...
AStarPathPlannerComponent::AStarPathPlannerComponent()
: AStarPathPlannerComponent{rclcpp::NodeOptions{}}
{
}

AStarPathPlannerComponent::AStarPathPlannerComponent(rclcpp::NodeOptions const & options)
: Node{"wheeliebot_a_star_path_planner_node", options},
...
auto AStarPathPlannerComponent::update_current_state(nav_msgs::msg::Odometry const & msg) -> void
{
  current_state_ = msg;
}

auto AStarPathPlannerComponent::update_target_pose(geometry_msgs::msg::PoseStamped const & msg)
  -> void
{
  target_pose_ = msg;
}

auto AStarPathPlannerComponent::update_planning_grid(nav_msgs::msg::OccupancyGrid const & msg)
  -> void
{
  planning_grid_ = detail::to_boost_graph(msg);
}

auto AStarPathPlannerComponent::make_path() -> std::optional<nav_msgs::msg::Path>
{
  if (!current_state_) {
  ...
  if (auto const vertex_path{
        detail::find_vertex_path_a_star(source_vertex, target_vertex, planning_grid)}) {
